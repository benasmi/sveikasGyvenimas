...
public class QuizActivity extends AppCompatActivity {
    ...
    public static final String[] question_26 = {"Kuris teiginys yra klaidingas?", "Alkoholis slopina smegenis ir visą organizmą, ilgina reakcijos laiką", "Alkoholis moteris veikia greičiau, net jei jos yra to paties svorio kaip ir vyrai", "\n" +
            "alkoholis kenksmingesnis paaugliams, nei suaugusiems", "alkoholis stimuliuoja smegenų veiklą ir visą organizmą", "alkoholis stimuliuoja smegenų veiklą ir visą organizmą"};
